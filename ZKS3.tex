...
\begin{center}
	\begin{tabular}{ |p{3cm}| p{6cm} | p{8cm} | }
		...
		Vartotojas aiškiai hamburgeryje pasirenka subkategorija, tačiau atėjųs į mielių puslapį mato tiktais nuotraukas ir nebeaišku kaip tiksliau atsirinkti mieles &
		Nelabai.
		\\ \hline
