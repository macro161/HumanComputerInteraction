...
\section{Pardavėjo poreikiai}
	...
	\subsection{Kompiuterizuojamų veiklų analizė}
		...
		\subsubsection{Veiklų charakteristikos}
			\subsubsubsection{Veiklos dažnis}
			\begin{itemize}
				\item{Naujokas pardavėjas - kadangi pardavėjas nepatyręs, tikriausiai neturi daug užsakymų, todėl sistema tikėtina nesinaudoja kiekvieną dieną. Svarbus sistemos naudojimosi aiškumas ir patikimumas.}
				\item{Patyręs pardavėjas - tikėtina, kad patyręs pardavėjas naudojasi sistema kiekvieną dieną. Sistema jau turėtų būti perprasta, todėl svarbus našumas, supaprastinta prieiga prie dažnai naudojamų funkcijų.}
				\end{itemize}
		\subsubsection{Problemos ir tobulėjimo galimybės}
		\subsubsection{Būsimasis scenarijus}
		\subsubsubsection{Pradedančio pardavėjo būsimasis scenarijus}
				\begin{enumerate}
