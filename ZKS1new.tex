	...
	\subsection{Kompiuterizuojamų veiklų analizė}
		...
		\subsubsection{Problemos ir tobulinimo galimybės}
					\begin{itemize}
						...
						\item{Paspaudus ant meniu juostos puslapis persikrauna, vietoj to, kad būtų tiesiog atidaromas pasirinkimo meniu(sumuštinis).}
					\end{itemize}
...
\section{Terminų žodynėlis}
	\begin{itemize}
		\item{Vartotojas - žmogus vartojantis parduotuvės paslaugomis(pirkdamas produktus ar žiūrėdamas informacija apie prekes)}
		\item{Aludaris - vartotojas}
		\item{Pardavėjas - žmiogus peržiūrintis ir paruošiantis užsakymus.}
	\end{itemize}
\section{Priedai}
