	...
	\subsection{Pradedantis aludaris pirmą kartą užsako}
		...
		\subsubsection{Veiklų charakteristikos}
			\begin{itemize}
				...
				\item{Bendradarbiavimas - Vartotojas nesusidurs su kitais vartotojais.
					Vartotojo bendraviams apsiriboja komunikacija su pardavėju kuris gali vartotojui patarti kokias prekes pirkti arba pasikonsultuoti dėl gamybos proceso}
...
\section{Pardavėjo poreikiai}
	\subsection{Naudotojų charakteristikos}
		...
		\subsubsection{Motyvacija ir galimybės tobulėti}
			Pardavėjui svarbu turėti galimybę matyti ir reguliuoti savo prekes ir užsakymus.
...
\section{Įkvepiančios esamų interfeisų idėjos}
	\subsection{Paieškos interfeisas}
		\begin{figure}[h]
			...
			\caption{ Paieškos pavyzdys iš www.1a.lt}
		\end{figure}
	...
	\subsection{Prekės charakteristikos interfeisas}
		\begin{figure}[h]
			...
			\caption{ Prekės charakteristikos pavyzdys iš www.1a.lt}
		\end{figure}
	...
	\subsection{Siūlomų panašių prekių interfeisas}
		\begin{figure}[h]
			...
			\caption{ Panašių prekių pavyzdys iš www.amazon.com}
		\end{figure}
	...
	\subsection{Interfeisas naujiems vartotojams}
		\begin{figure}[h]
			...
			\caption{ Naujo vartotojo interfeisas iš www.varle.lt}
		\end{figure}
	...
	\subsection{Atsiskaitymo interfeisas}
		\begin{figure}[h]
			...
			\caption{ Atsiskaitymo formos pavyzdys iš www.varle.lt}
		\end{figure}
